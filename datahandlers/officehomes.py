...
class OfficeHomeDataset(torchvision.datasets.VisionDataset):
    def __init__(self, envs, classes, train=True, transform=None, target_transform=None):
        ENVIRONMENTS = ["A", "C", "P", "R"]
        datasetholder = OfficeHome('/cis/home/adesilva/ashwin/research/ood-tl/data', envs)
...
class OfficeHomeHandler(DatasetHandler):
    def __init__(self, cfg):
        ...
        dataset = OfficeHomeDataset(envs, classes, transform=train_transform)
